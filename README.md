Travis build: [![Build Status](https://travis-ci.org/holger1411/btheme.svg?branch=master)](https://travis-ci.org/holger1411/btheme) | Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/btheme.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/btheme)

#### See: [Official Demo](https://btheme.com/btheme) | Read: [Official Docs Page](https://btheme.github.io/)

# bTheme WordPress Theme Framework

Website: [https://btheme.com](https://btheme.com)
...
That’s what bTheme is.
You can use it as starter theme and build your own theme on top of it. Or you use it as parent theme and create your own child theme for bTheme.

## License
bTheme is released under the terms of the GPL version 2 or (at your option) any later version.
...
- [Child Theme](https://github.com/holger1411/btheme-child) ready.
- Translation ready.
...
Some basics about the Sass and CSS files that come with bTheme:
- The theme itself uses the `/style.css`file just to identify the theme inside of WordPress. The file is not loaded by the theme and does not include any styles.
- The `/css/theme.css` and its minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:

                  - 1 "theme/theme_variables";  // <--------- Add your variables into this file. Also add variables to overwrite Bootstrap or bTheme variables here
                  - 2 "../src/bootstrap-sass/assets/stylesheets/bootstrap";  // <--------- All the Bootstrap stuff - Don´t edit this!
                  - 3 "btheme/btheme"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
### Classic install
- Download the btheme folder from GitHub or from [https://btheme.com](https://btheme.com)
- IMPORTANT: If you download it from GitHub make sure you rename the "btheme-master.zip" file just to "btheme.zip" or you might have problems using child themes !!
- Upload it into your WordPress installation subfolder here: `/wp-content/themes/`
- Login to your WordPress backend
- Go to Appearance → Themes
- Activate the bTheme theme

### npm install
- Open your terminal
- Change to the directory where you want to add bTheme
- Type `npm install btheme`
...
- Then open your terminal and browse to the location of your bTheme copy
- Run: `$ npm install`

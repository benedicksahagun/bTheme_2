				...
				<main class="site-main" id="main" role="main">
					...
					<section class="error-404 not-found">
						...
						<div class="page-content">
							...
							<?php if ( btheme_categorized_blog() ) : // Only show the widget if site has multiple categories. ?>

								<div class="widget widget_categories">

									<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'btheme' ); ?></h2>
